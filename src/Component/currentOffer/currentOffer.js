    ...
    return(
        <div className={style.wrapper}>
            ...
            <div className={style.currentOffer}>
                ...
                <button disabled={props.isPressedBack} onClick={() => props.scrollOfferBox('back')}>Назад</button>
                <button disabled={props.isPressedNext} onClick={() => props.scrollOfferBox('next')}>Вперед</button>
